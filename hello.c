...
#define __PYX_HAVE__QiangGui__hello
#define __PYX_HAVE_API__QiangGui__hello
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'QiangGui.hello' */
#define __Pyx_MODULE_NAME "QiangGui.hello"
int __pyx_module_is_main_QiangGui__hello = 0;

/* Implementation of 'QiangGui.hello' */
static char __pyx_k_[] = "\344\275\240\345\245\275";
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_QiangGui__hello) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "QiangGui.hello")) {
      if (unlikely(PyDict_SetItemString(modules, "QiangGui.hello", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * print u""             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_n_u_) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init QiangGui.hello", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init QiangGui.hello");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
